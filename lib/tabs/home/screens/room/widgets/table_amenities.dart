...
import 'package:project/tabs/home/screens/room/widgets/widget_screen.dart';
      ...
      child: Table(
        children: [
          TableRow(children: [
            ...
            TableCell(
                child: Microphone(widget._amenities['microphone'] as bool)),
            TableCell(child: PC(widget._amenities['pc'] as bool)),
            TableCell(child: Speakers(widget._amenities['speakers'] as bool)),
            TableCell(child: Screen(widget._amenities['screen'] as bool))
          ])
        ],
      ),
    );
